 ...
 */
package com.axelixlabs.axelix.sbs.spring.scheduled;
    ...
    private static final String EXPECTED_JSON =
            ...
            """
      {
        "cron": [
         {
              "runnable": {
               "target": "com.axelixlabs.axelix.sbs.spring.scheduled.AxelixScheduledTasksEndpointTest$ScheduledTasksEndpointExtensionTestConfiguration.testCronTask"
              },
              "expression": "*/1 * * * * *",
              "enabled": true
          }
       ...
       "fixedDelay": [
          {
              "runnable": {
               "target": "com.axelixlabs.axelix.sbs.spring.scheduled.AxelixScheduledTasksEndpointTest$ScheduledTasksEndpointExtensionTestConfiguration.testFixedDelayTask"
              },
              "initialDelay": 0,
              "interval": 1000,
              "enabled": true
        ...
        "fixedRate": [
          {
             "runnable": {
               "target": "com.axelixlabs.axelix.sbs.spring.scheduled.AxelixScheduledTasksEndpointTest$ScheduledTasksEndpointExtensionTestConfiguration.testFixedRateTask"
             },
             "initialDelay": 100,
             "interval": 1000,
             "enabled": true
        ...
        "custom": [
          {
             "runnable": {
               "target": "com.axelixlabs.axelix.sbs.spring.scheduled.AxelixScheduledTasksEndpointTest$ScheduledTasksEndpointExtensionTestConfiguration$CustomTestTask"
             },
    ...
    static class ScheduledTasksEndpointExtensionTestConfiguration implements SchedulingConfigurer {
        ...
        static class CustomTestTask implements Runnable {
            ...
            public String toString() {
                return "com.axelixlabs.axelix.sbs.spring.scheduled.AxelixScheduledTasksEndpointTest$ScheduledTasksEndpointExtensionTestConfiguration$CustomTestTask";
            }
        }

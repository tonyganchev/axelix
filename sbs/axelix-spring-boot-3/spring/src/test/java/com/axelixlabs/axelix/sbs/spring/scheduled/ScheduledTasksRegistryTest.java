...
class ScheduledTasksRegistryTest {
    ...
    private static final String CRON_TASK_ID =
            ScheduledTasksRegistryTest.ScheduledTaskRegistryTestConfiguration.class.getName() + ".testCronTask";
    private static final String FIXED_DELAY_TASK_ID =
            ScheduledTasksRegistryTest.ScheduledTaskRegistryTestConfiguration.class.getName() + ".testFixedDelayTask";
    private static final String FIXED_RATE_TASK_ID =
            ScheduledTasksRegistryTest.ScheduledTaskRegistryTestConfiguration.class.getName() + ".testFixedRateTask";
    private static final String CUSTOM_TASK_ID =
            ScheduledTasksRegistryTest.ScheduledTaskRegistryTestConfiguration.class.getName() + ".testCustomTask";

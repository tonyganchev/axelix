...
/**
 * Integration tests for {@link DisableCacheManagerEndpointProber}.
 * *
 * @since 26.11.2025
 * @author Nikita Kirillov
 */
@SpringBootTest(classes = ApplicationEntrypoint.class)
class DisableCacheManagerEndpointProberTest {
    ...
    @Autowired
    private DisableCacheManagerEndpointProber disableCacheManagerEndpointProber;
    ...
    void shouldDisableCacheManager() {
        ...
        assertThatNoException()
                .isThrownBy(() -> disableCacheManagerEndpointProber.invoke(InstanceId.of(activeInstanceId), payload));
    }
    ...
    void shouldThrowExceptionWhenInstanceNotFound() {
        ...
        assertThatThrownBy(() -> disableCacheManagerEndpointProber.invoke(unregisteredInstanceId, payload))

...
import com.axelixlabs.axelix.master.api.external.endpoint.TransactionMonitoringApi;
...
class TransactionMonitoringApiTest {
    ...
    private static final String EXPECTED_TRANSACTION_MONITORING_JSON =
            // language=json
            """
      {
        "entrypoints": [
    ...
    void shouldReturnJSONTransactionsMonitoringFeed() throws InterruptedException {
        ...
        assertThatJson(body).when(IGNORING_ARRAY_ORDER).isEqualTo(EXPECTED_TRANSACTION_MONITORING_JSON);

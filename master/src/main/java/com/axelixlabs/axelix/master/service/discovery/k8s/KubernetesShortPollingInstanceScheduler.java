 ...
 */
public class KubernetesShortPollingInstanceScheduler {

    private static final Logger logger = LoggerFactory.getLogger(KubernetesShortPollingInstanceScheduler.class);

    private final InstancesDiscoverer instancesDiscoverer;
    private final InstanceRegistry instanceRegistry;
    private final MemoryUsageCache memoryUsageCache;

    public KubernetesShortPollingInstanceScheduler(

...
/**
 * {@link AbstractEndpointProber} that specifically works with {@link ActuatorEndpoints#INFO /info} endpoint.
 *
 * @author Sergey Cherkasov
 */
@Service
public class InfoEndpointProber extends AbstractEndpointProber<ServiceInfo> {

    public InfoEndpointProber(
            InstanceRegistry instanceRegistry,
            MessageDeserializationStrategy<ServiceInfo> messageDeserializationStrategy) {
